...
5. Existing [`platforms/azure/artifacts/historical/csvs`](../../platforms/azure/artifacts/historical/csvs) files predate this audit. They are retained as historical Azure review artifacts and should be regenerated only during a verified cloud execution phase.
